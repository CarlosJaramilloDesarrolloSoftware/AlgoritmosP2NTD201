...
//CONTADORES
let  contadorNinos = 0, contadorJovenes = 0, contadorAdultos= 0, contadorViejos = 0, contadoredaderror = 0, contbajopeso,
contpesonormal,contpesosuperior,contobesidad;
//ACUMULADORES 
let CantidadDeEncuestados =0 ,AcumuladorIMC = 0;
...
while(N == "*"){
    ...
    peso = prompt("Ingrese la edad");
    estatura = prompt("Ingrese la edad");
